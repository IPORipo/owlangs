        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 contact-info-block">
                    <h4><span><?php echo app('translator')->getFromJson('en.Company name'); ?></span>: New Future sp. z o.o.</h4>
                    <h4><span><?php echo app('translator')->getFromJson('en.address'); ?></span>: Krawiecka 3/10, Wrocław 50-148, Poland</h4>
                    <img src="<?php echo e(asset('images/center.jpg')); ?>" alt="">
                    <h4>NIP/tax <?php echo app('translator')->getFromJson('en.identification number'); ?>: <strong>8971805495</strong></h4>
                    <h4><?php echo app('translator')->getFromJson('en.How to contact us'); ?>:<br><?php echo app('translator')->getFromJson('en.phone'); ?>: <strong>+48 727 901 680</strong><br>email: <strong><a href="mailto:office@newfuture.company">office@newfuture.company</a></strong>
                    </h4>
                </div>
            </div>
        </div>
